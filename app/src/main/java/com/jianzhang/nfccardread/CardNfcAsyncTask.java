...
import com.jianzhang.nfccardread.parser.EmvParser;
import com.jianzhang.nfccardread.utils.Provider;
        ...
        if (!mException) {
            if (mCard != null) {
                if (StringUtils.isNotBlank(mCard.getCardNumber())) {
                    ...
                    mHolderName = mCard.getHolderFirstname() + " " + mCard.getHolderLastname();
